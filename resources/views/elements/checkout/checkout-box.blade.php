    ...
    <div class="col-lg-6 mx-auto">
        ...
        <div class="paymentOption paymentPP d-none">
            <form id="pp-buyItem" method="post" action="{{route('payment.initiatePayment')}}">
                ...
                <input type="hidden" name="cardcvv" id="cardCvv" value="">
                <input type="hidden" name="card_number" id="paymentCardNumber" value="">
                <input type="hidden" name="expire_date" id="paymentExpireDate" value="">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-12 mb-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="cardnumber" id="cardnumber" placeholder="{{__('Card Number')}}"  required onchange="checkout.validateCardNumberField();" class="form-control uifield-card_number">
                                                            </div>
                                                            <div class="row">
                        ...
                        <div>
                            ...
                            <div class="d-flex text-left radio-group row">
                                ...
                                <div class="p-0 col-6 col-md-3" {!! !Auth::check() || Auth::user()->wallet->total <= 0 ? 'data-toggle="tooltip" data-placement="right"' : '' !!} title="{{__('You can use the wallet deposit page to add credit.')}}">
                                    <div class="radio mx-auto wallet-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center" data-value="credit">
                                ...
                                <div class="p-0 col-6 col-md-3"  title="{{__('You can use the credit card as well.')}}">
                                    <div class="radio mx-auto creditcard-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center" data-value="creditcard">
                                        <div class="card-provider-text">
                                            <b>{{__("Pay with credit card")}}</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
