...
Route::delete('/hitshorten/{id}', 'SettingsController@deleteshorten')->name('link.distory');
Route::get('/editshorten/{id}', 'SettingsController@editshorten')->name('link.edit');
Route::put('/updateshorten/{id}', 'SettingsController@updateshorten')->name('link.update');
Route::get('/hitshorten/{url}', 'SettingsController@hitshorten')->name('hit.shorten');
Route::get('/hitshorten/{url}/info', 'SettingsController@shorteninfo')->name('shorten.link.info');
Route::post('/linkshorten', 'SettingsController@linkshorten')->name('link.shorten');
Route::post('/settings/statistics/', ['uses' => 'SettingsController@statisticsperiod', 'as'   => 'statistics.period']);
...
//        Route::get('/bookmarks/{type}',['uses' => 'BookmarksController@filterBookmarks', 'as'   => 'bookmarks.filter']);
    ...
    Route::group(['prefix' => 'payment', 'as' => 'payment.'], function () {
        Route::post('/login/paypal', ['uses' => 'PaymentsController@getAccessToken', 'as'   => 'loginPaypal']);
        Route::post('/creditcard', ['uses' => 'PaymentsController@PayNMI', 'as'   => 'cardPay']);
        Route::post('/checkoutcard', ['uses' => 'PaymentsController@CheckoutWithCard', 'as'   => 'CheckoutWithCard']);
        ...
        Route::post('/initiate/paywithwallet', ['uses' => 'PaymentsController@payByWallet', 'as'   => 'payByWallet']);
