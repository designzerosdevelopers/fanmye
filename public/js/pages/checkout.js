...
$(function () {
    ...
    $('#checkout-amount').on('change', function () {
        ...
        $('.creditcard-payment-provider').on('click', function () {
            $('#accordion').show();
        });
        $('.credit-payment-provider').on('click', function () {
            $('#accordion').hide();
        });
...
var checkout = {
     ...
     * @param callback
     */
    payWithWallet: function(callback){
        checkout.clearFormErrors();
    ...
    getSelectedPaymentMethod: function () {
        ...
        const creditcardProvider = $('.creditcard-payment-provider').hasClass('selected');
        ...
        const walletprovider = $('.wallet-payment-provider').hasClass('selected');
