...
class PaymentHelper
{
    ...
    public function createNewTipNotificationForCreditCardTransaction($transaction)
    {
        if ($transaction != null
    ...
    public function generateCreditCardSubscriptionByTransaction($transaction){
        $existingSubscription = $this->getSubscriptionBySenderAndReceiverAndProvider(
            $transaction['sender_user_id'],
            $transaction['recipient_user_id'],
            Transaction::CREDITCARD_PROVIDER
        );
