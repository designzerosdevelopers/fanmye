...
class NotificationServiceProvider extends ServiceProvider
{
        ...
        try {
            ...
            if ($postComment != null && isset($postComment->id) && isset($postComment->message) && isset($postComment->post_id)) {
                ...
                if (isset($user->settings['notification_email_new_comment']) && $user->settings['notification_email_new_comment'] == 'true') {
                        ...
                        You've received a new comment on one of your posts at :siteName.", ['siteName' => getSetting('site.name')]) . "
                ...
                if (isset($user->settings['notification_email_new_sub']) && $user->settings['notification_email_new_sub'] == 'true') {
                    ...
                    EmailsServiceProvider::sendGenericEmail(
                        [
                            ...
                            You got a new subscriber! You can see more details over your subscriptions tab.
            ...
            if (
                ...
                if ($sender != null) {
                    $amount = PaymentsServiceProvider::getTransactionAmountWithTaxesDeducted($transaction);
                            $notificationData['message'] = "Dear user,
                            
                            We hope this message finds you well.
                            
                            We want to inform you that we have successfully received the payment on your behalf for a recent transaction conducted on Fanmye.com. We sincerely appreciate your involvement and wish to extend our gratitude for your participation.
                            
                            Confirmation of Transaction:
                            We have processed the payment and it has been credited to your account on Fanmye.com. Below, you will find the transaction details:
                            
            Payment Date:" . \Carbon\Carbon::now()->format('F j, Y') . "
            Transaction Type:Tip
            Sender Name:" . $sender->name . "
            Amount:" . $amount . " " . $transaction->currency . "
                            
                            Should you have any inquiries or require clarification regarding this transaction or the funds received, please feel free to get in touch with our support team at support@fanmye.com. We are here to address any questions you may have.
                            
                            Here at Fanmye.com, we are dedicated to providing exceptional service to all our users. If you need assistance or have any questions, our support team is available to assist you promptly. Please don't hesitate to reach out to them at support@fanmye.com, and they will be more than happy to assist you.
                            
                            Once again, we want to express our gratitude for your involvement with Fanmye.com. Your contributions are invaluable to our community, and we deeply appreciate your participation.
            ...
            if($stream && $type === Notification::EXPIRING_STREAM) {
                ...
                $message = __('Dear user,
                            ...
                            Your live stream is about to end in 30 minutes. You can start another one afterwards.
                ...
                if (isset($subscription->subscriber->settings['notification_email_renewals'])
                    ...
                    EmailsServiceProvider::sendGenericEmail(
                        [
                            ...
                            Your email subscription updated.
                            
                            Best Regards,
                            The Team at Fanmye
                            support@fanmye.com
                            Fanmye.co', ['name'=>$subscription->creator->name, 'message'=>$message]),
                            'button' => [
                                'text' => $buttonText,
                                'url' => $buttonUrl,
                            ],
    ...
    public static function sendApprovedDepositTransactionEmailNotification($transaction) {
        if($transaction && $transaction->status === Transaction::APPROVED_STATUS && $transaction->type === Transaction::DEPOSIT_TYPE){
            ...
            Your deposit request of :amount has been approved.', ['amount' => $transaction->amount] . '
